...
<div class="top-bar">
    ...
    <div class="add_equipment">
        <form action="addstudiosession.php" method="post">
            <h1>ADD STUDIO SESSION</h1>
            <label for="description"><b>Studio Session Description:</b></label><br>
            <textarea type="text" name="description" id="description" placeholder="Describe your studio session,state available time,duration and characteristics in general"></textarea><br><br>
...
<?php 
     ...
     if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $sql = "INSERT INTO studiosession (description, price) VALUES ('$description', '$price')";
